        ...
        <div className="wrapper">
              ...
              <div className='text-center' id='faq'>
                ...
                <div className='grid md:grid-cols-5 grid-cols-2 gap-4 !mt-4'>
                    {/* Card  */}
                    <div className='md:w-[250px] hover:scale-105 rounded-xl active:border-[var(--primary-color)] active:scale-105  border border-gray-300 hover:border-[var(--primary-color)] transition-all   flex flex-col gap-4 text-center !p-4'> 
                        <Image src={'/truck1.png'} alt='DryVan' width={250} height={100}/>
                        <p className='text-lg font-bold font-[Orbitron]'>Dry Van</p>

                    </div>
                        {/* Card  */}
                        <div className='md:w-[250px] rounded-xl  border border-gray-300 active:border-[var(--primary-color)] active:scale-105  hover:border-[var(--primary-color)] transition-all hover:scale-105 focus-within:scale-105 flex flex-col gap-4 text-center !p-4'> 
                        <Image src={'/truck2.png'} alt='DryVan' width={250} height={100}/>
                        <p className='text-lg font-bold font-[Orbitron]'>Reefer</p>

                    </div>
                        {/* Card  */}
                        <div className='md:w-[250px] rounded-xl  border border-gray-300 active:border-[var(--primary-color)] active:scale-105  hover:border-[var(--primary-color)] transition-all hover:scale-105 activate:border-[var(--primary-color)] flex flex-col gap-4 text-center !p-4'> 
