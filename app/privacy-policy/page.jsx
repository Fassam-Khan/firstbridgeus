    ...
    return (
        <div>
            ...
            <div className='md:w-[600px] w-full !m-auto flex flex-col gap-10 '>
                ...
                {/* Card  */}
                <div className='flex shadow-2xl flex-col gap-4 md:!p-6 rounded-2xl border-l-2 border-[var(--primary-color)]'>
                ...
                <div className='flex shadow-2xl flex-col gap-4 md:!p-6 rounded-2xl border-l-2 border-[var(--primary-color)]'>
                   ...
                   {/* Card  */}
                   <div className='!mb-10 flex shadow-2xl flex-col gap-4 md:!p-6 rounded-2xl border-l-2 border-[var(--primary-color)]'>
